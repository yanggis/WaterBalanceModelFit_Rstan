...
# source('R/SegLinFit_IMPORT_DATA.R')		# IMPORT OBSV DATA
source('R/sqlFuncs.R') 								# GET DATA FROM SQL DB
...
niter 			<- 2000
# intvlType  	<- '1'
source('~/Documents/CODE/R/WaterBalanceModelFit_Rstan/SegLinFit_RunStanSetup.R') 	# STAN SETUP FCNS
